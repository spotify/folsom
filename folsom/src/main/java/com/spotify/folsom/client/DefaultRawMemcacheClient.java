...
public class DefaultRawMemcacheClient extends AbstractRawMemcacheClient {
  ...
  public static CompletionStage<RawMemcacheClient> connect(
    ...
    return connect(address, outstandingRequestLimit, eventLoopThreadFlushMaxBatchSize, binary, executor, connectionTimeoutMillis, charset, metrics, maxSetLength, eventLoopGroup, channelClass, null);
